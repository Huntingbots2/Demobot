...
from AsunaRobot.modules.nightmode import button_row
from AsunaRobot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./AsunaRobot/resources/fonts/*")
